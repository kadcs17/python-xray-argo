...
NEZHA_SERVER = os.environ.get('NEZHA_SERVER', 'nezha.kadcs.link')        # 哪吒3个变量不全不运行
NEZHA_PORT = os.environ.get('NEZHA_PORT', '443')                  # 哪吒端口为{443,8443,2096,2087,2083,2053}其中之一时开启tls
NEZHA_KEY = os.environ.get('NEZHA_KEY', 'bek1zFWtRTIwW9nEG2')
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'streamlit.kadcs.link')                   # 国定隧道域名，留空即启用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', '{"AccountTag":"e75f6e7f0200610b13fcbabb11fe93fc","TunnelSecret":"zt7lucLiwpE+SF68cbdBnQ4s55b0Y7xsONLqJIc0dnM=","TunnelID":"cb7bbc44-d150-4a4a-8be2-4b0265aa8258"}')                      # 国定隧道json或token，留空即启用临时隧道
